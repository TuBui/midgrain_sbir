    ...
    def fit(self, data):
        ...
        while self.kmax is None or k <= self.kmax:
            ...
            centroid_distances = euclidean_distances(
                self._model.centroids, self._model.centroids)
        ...
        self.model = KMeans(k, init=init).fit(data)
# =============================================================================
#         MiniBatch(
#             k,
#             compute_labels = True,
...
# =============================================================================
    ...
    def _fit(self, k, data, centroids=None):
        ...
        model = KMeans(k, init=init).fit(data)
# =============================================================================
#         MiniBatch(
#             k,
#             compute_labels = True,
...
#                     var = np.sum((ci[ci_labels == l] - sm[l])**2)/float(rn - 1)
